...
public:
  ...
  Eigen::Vector3d closestPointOnSegment(int index, const Eigen::Vector3d &pos)
  {
    ...
    Eigen::Vector3d centre = segments_[segment.parent_id].tip + dif * d;
    return centre + (pos - centre).normalized() * segment.radius;
  }
