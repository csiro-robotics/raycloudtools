...
void Occupancy2D::init(const Eigen::Vector3d &min_bound, const Eigen::Vector3d &max_bound, double pixel_width)
{
...
/// save the grid
void Occupancy2D::save(const std::string &filename)
{
...
/// load the grid
bool Occupancy2D::load(const std::string &filename)
{
...
void Occupancy2D::fillDensities(const std::string &cloudname, const Eigen::ArrayXXd &lows, double clip_min, double clip_max)
{
  ray::Cuboid bounds_;
