...
void clustersAgglomerate(const std::vector<Eigen::Vector3d> &points, double min_diameter, double max_diameter, std::vector< std::vector<int> > &point_clusters)
{
...
void clustersKMeans(const std::vector<Eigen::Vector3d> &points, double max_diameter, std::vector< std::vector<int> > &point_clusters)
{
...
std::vector< std::vector<int> > generateClusters(const std::vector<Eigen::Vector3d> &points, double min_diameter, double max_diameter, bool agglomerate, bool verbose)
{
