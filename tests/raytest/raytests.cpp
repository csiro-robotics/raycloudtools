...
namespace raytest
{
  ...
  TEST(Basic, RayAlign)
  {
    EXPECT_EQ(system("raycreate room 1"), 0);
    EXPECT_EQ(system("cp room.ply room2.ply"), 0);
    EXPECT_EQ(system("rayrotate room2.ply 0,0,35"), 0);
    EXPECT_EQ(system("rayalign room.ply room2.ply"), 0);
    ray::Cloud cloud;
  ...
  {
    EXPECT_EQ(system("raycreate room 1"), 0);
    EXPECT_EQ(system("raycolour room.ply normal"), 0);
    ray::Cloud cloud;
  ...
  TEST(Basic, RayCombine)
  {
    EXPECT_EQ(system("raycreate room 1"), 0);
    EXPECT_EQ(system("cp room.ply room2.ply"), 0);
    EXPECT_EQ(system("raytranslate room2.ply 0,0,1"), 0);
    EXPECT_EQ(system("rayrotate room2.ply 0,0,35"), 0);
    EXPECT_EQ(system("raycombine min room.ply room2.ply 1 rays"), 0);
    ray::Cloud cloud;
  ...
  {
    EXPECT_EQ(system("raycreate building 1"), 0);
    ray::Cloud cloud;
  ...
  {
    EXPECT_EQ(system("raycreate forest 1"), 0);
    EXPECT_EQ(system("raydecimate forest.ply 10 cm"), 0);
    ray::Cloud cloud;
  ...
  {
    EXPECT_EQ(system("raycreate room 1"), 0);
    EXPECT_EQ(system("raydenoise room.ply 3 cm"), 0);
    ray::Cloud cloud;
  ...
  TEST(Basic, RayRestore)
  {
    EXPECT_EQ(system("raycreate room 1"), 0);
    EXPECT_EQ(system("cp room.ply room2.ply"), 0);
    EXPECT_EQ(system("raydecimate room2.ply 10 cm"), 0);
    EXPECT_EQ(system("raytranslate room2_decimated.ply 1,2,3"), 0);
    EXPECT_EQ(system("rayrotate room2_decimated.ply 0,0,-50"), 0);
    EXPECT_EQ(system("rayrestore room2_decimated.ply 10 cm room.ply"), 0);
    ray::Cloud cloud;
  ...
  {
    EXPECT_EQ(system("raycreate forest 1"), 0);
    EXPECT_EQ(system("rayrotate forest.ply 10,20,30"), 0);
    ray::Cloud cloud;
  ...
  {
    EXPECT_EQ(system("raycreate room 1"), 0);
    EXPECT_EQ(system("raysmooth room.ply"), 0);
    ray::Cloud cloud;
  ...
  {
    EXPECT_EQ(system("raycreate room 1"), 0);
    EXPECT_EQ(system("raysplit room.ply pos 0,0.1,1.5"), 0);
    ray::Cloud cloud;
  ...
  {
    EXPECT_EQ(system("raycreate room 2"), 0);
    EXPECT_EQ(system("raytransients min room.ply 1 rays"), 0);
    ray::Cloud cloud;
  ...
  {
    EXPECT_EQ(system("raycreate forest 1"), 0);
    EXPECT_EQ(system("raytranslate forest.ply 10,20,30"), 0);
    ray::Cloud cloud;
    EXPECT_TRUE(cloud.load("forest.ply"));
  ...
  TEST(Basic, RayWrap)
  {
    EXPECT_EQ(system("raycreate terrain 1"), 0);
    EXPECT_EQ(system("raywrap terrain.ply upwards 1.0"), 0);
    ray::Mesh mesh;
