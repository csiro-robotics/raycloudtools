...
int main(int argc, char *argv[])
{
  ...
  ray::ViewDirection view_dir = static_cast<ray::ViewDirection>(viewpoint.selectedID());
  ray::RenderStyle render_style = static_cast<ray::RenderStyle>(style.selectedID());
